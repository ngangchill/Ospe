...
<div class="row">
  <div class="col-md-12">
    {!! form_open('articles/'.$post['id'].'/edit', ['id'=>'contentForm', 'role'=>'form', 'class'=>'form-horizontal']) !!}
    <h2>Content:<small> Click on "+" and start writting </small></h2>
    {!! form_hidden('id', $post['id']) !!}
    <div class="control-group">
    {{ dump($post['postContent']) }}
      {!! form_textarea('content', $post['postContent'], ['name' => 'content',
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Article Info</h4>
          </div>
          <div class="modal-body">

            <div class="form-group">
              <label for="postTitle">Post Title</label>
              {!! form_input('postTitle', $post['postTitle'], ['id'=>'postTitle','class'=>'form-control', 'placeholder'=> 'Post Title']) !!}
            </div>

            <div class="form-group">
              <label for="postExcerpt">Post Excerpt</label>
              {!! form_textarea('postExcerpt', $post['postExcerpt'], ['name' => 'postExcerpt','id' => 'postExcerpt', 'class' => 'form-control']); !!}
            </div>

            <div class="form-group">
              <label for="uri">uri</label>
              {!! form_input('uri', $post['slug'], ['id'=>'uri','class'=>'form-control', 'placeholder'=> 'uri']) !!}
            </div>

            <div class="form-group">
              <label for="postImage">postImage</label>
              {!! form_input('postImage', $post['postImage'], ['id'=>'postImage','class'=>'form-control', 'placeholder'=> 'postImage']) !!}
            </div>
            <div class="form-group">
              <label for="postStatus">postStatus</label>
              {!! form_input('postStatus', $post['postStatus'], ['id'=>'postStatus','class'=>'form-control', 'placeholder'=> 'postStatus']) !!}
            </div>
