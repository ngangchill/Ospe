 ...
 * @author forhad
 */
class UserAgent extends \Forhad\Plugin\Plugin {
    ...
    function beforeShow($pages) {
        $this->load(['ua' => $this->_read_user_agent()]);
    }

    // public function readRequestedFile($requestedFile)
    // {
    //     dump($requestedFile);
    // }
